...
export default function FinesList() {
  ...
  return (
    <div className="space-y-6 font-sans-ui text-ink-primary">
      ...
      <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 border-b border-border-archival pb-4">
        <div>
        ...
        <div className="flex items-center gap-2.5">
          <button
            type="button"
            onClick={loadFines}
            className="inline-flex items-center gap-1.5 px-3.5 py-2 border border-border-archival bg-white hover:bg-parchment-subtle rounded-lg text-xs font-semibold text-ink-muted transition-colors shadow-xs"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-archival-teal text-white rounded-lg hover:bg-archival-deep transition-all shadow-xs text-xs font-semibold"
          >
            <Plus className="w-4 h-4" />
            <span>Record Fine / Fee</span>
          </button>
        </div>
      </div>
